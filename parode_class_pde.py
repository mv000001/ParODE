# parode_class_pde.py
# ParODE: GPU-parallel fixed-point ODE solver (PDE-residual augmented)
# Author: (adapted for you) Martin Veselsky style
# Date: 2025
...
if __name__ == "__main__":
    ...
    solver = ParODE(M=10, N=10, K=200000, ic_weight=1e3, reg_lambda=1e-8)
